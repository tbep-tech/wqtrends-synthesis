...
This summary document provides a synthesis of model results for multiple parameters and stations in South Bay.  The goal is provide a single location to quickly assess model fit and overall trends.  All results were obtained using the [wqtrends](https://tbep-tech.github.io/wqtrends/) R package.  Source code for this file is available [here](https://github.com/tbep-tech/wqtrends-synthesis), including access to all image files [here](https://github.com/tbep-tech/wqtrends-synthesis/tree/main/figs).
